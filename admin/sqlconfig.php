...
array_push($report_questions_data, array(131, 8, '07', 'Total State Government Funds (8.2 + 8.3 + 8.4 + 8.5)', 'Calculation', '126,127,128,129', 'Currency'));
...
array_push($report_questions_data, array(136, 8, '12', 'Total Federal Government Funds (8.8 + 8.9 + 8.10)', 'Calculation', '132,133,134', 'Currency'));
...
array_push($report_questions_data, array(139, 8, '15', 'TOTAL all other receipts (8.13 + 8.14)', 'Calculation', '137,138', 'Currency'));
array_push($report_questions_data, array(140, 8, '16', 'Other non-capital receipts placed in reserve funds', 'Direct', NULL, 'Currency'));
array_push($report_questions_data, array(141, 8, '17', 'TOTAL receipts (8.1 + 8.7 + 8.12 + 8.15)', 'Calculation', '123,131,136,139', 'Currency'));
...
array_push($report_questions_data, array(150, 9, '03', 'Total Staff Expenditures (9.1 + 9.2)', 'Calculation', '147,148', 'Currency'));
...
array_push($report_questions_data, array(155, 10, '04', 'TOTAL Collection Expenditures (10.1 + 10.2 + 10.3)', 'Calculation', '151,152,153', 'Currency'));
...
array_push($report_questions_data, array(157, 11, '02', 'TOTAL operating expenditures (9.3 + 10.4 + 11.1)', 'Calculation', '150,155,156', 'Currency'));
...
array_push($report_questions_data, array(160, 12, '01c', 'Total Local Government (12.1a + 12.1b)', 'Calculation', '158,159', 'Currency'));
...
array_push($report_questions_data, array(165, 12, '06', 'Total Capital Revenue (12.1c + 12.2 + 12.3 + 12.4)', 'Calculation', '161,162,163', 'Currency'));
...
array_push($report_questions_data, array(223, 15, '09', 'Total Number of Children\'s Synchronous Programs', 'Calculation', '215,219', 'Integer'));
array_push($report_questions_data, array(224, 15, '10', 'Total Attendance at Children\'s Synchronous Programs', 'Calculation', '216,220', 'Integer'));
array_push($report_questions_data, array(225, 15, '11', 'Total Number of Children\'s Self-Directed (Asynchronous) Activites', 'Calculation', '217,221', 'Integer'));
array_push($report_questions_data, array(226, 15, '12', 'Participants at Children\'s Self-Directed (Asynchronous) Activities', 'Calculation', '218,222', 'Integer'));
...
array_push($report_questions_data, array(239, 15, '25', 'Total Number at Synchronous Programs', 'Calculation', '227,231,235,223', 'Integer'));
array_push($report_questions_data, array(240, 15, '26', 'Total Attendance at Synchronous Programs', 'Calculation', '228,232,236,224', 'Integer'));
array_push($report_questions_data, array(241, 15, '27', 'Total Number of Self-Directed (Asynchronous) Activities', 'Calculation', '223,229,233,237', 'Integer'));
array_push($report_questions_data, array(242, 15, '28', 'Total Participants at Self-Directed (Asynchronous) Activities', 'Calculation', '224,230,234,238', 'Integer'));
...
array_push($report_questions_data, array(249, 15, '35', 'Total Synchronous Program Sessions', 'Calculation', '243,245,247', 'Integer'));
array_push($report_questions_data, array(250, 15, '36', 'Total Synchronous Program Session Attendance', 'Calculation', '244,246,248', 'Integer'));
...
array_push($report_questions_data, array(260, 16, '03', 'Total Number of Registered Cards (16.1 + 16.2)', 'Calculation', '255,256', 'Integer'));
...
array_push($report_questions_data, array(263, 17, '01', 'Books Held at the end of the fiscal year (volume count)', 'Query', 'SELECT `Total` FROM `SRPhysicalCollection` WHERE (DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) < DATE(\'|endyear|-|startmonth|-01\')) AND (`Material` = \'Book\') AND (`MaterialType` = \'Physical\') ORDER BY DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) DESC, LIMIT 1', 'Integer'));
array_push($report_questions_data, array(264, 17, '02', 'Current Print Serial Subscriptions', 'Query', 'SELECT `Total` FROM `SRPhysicalCollection` WHERE (DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) < DATE(\'|endyear|-|startmonth|-01\')) AND (`Material` = \'Serial Subscription\') AND (`MaterialType` = \'Physical\') ORDER BY DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) DESC, LIMIT 1', 'Integer'));
array_push($report_questions_data, array(265, 17, '03', 'Total Print Materials (17.1 + 17.2)', 'Calculation', '263,264', 'Integer'));
array_push($report_questions_data, array(266, 17, '04', 'E-books Held at end of the fiscal year', 'Query', 'SELECT `Total` FROM `SRPhysicalCollection` WHERE (DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) < DATE(\'|endyear|-|startmonth|-01\')) AND (`Material` = \'Book\') AND (`MaterialType` = \'Digital\') ORDER BY DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) DESC, LIMIT 1', 'Integer'));
array_push($report_questions_data, array(267, 17, '05a', 'Audio Recordings: Physical Units Held at end of the fiscal year', 'Query', 'SELECT `Total` FROM `SRPhysicalCollection` WHERE (DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) < DATE(\'|endyear|-|startmonth|-01\')) AND (`Material` = \'Audio\') ORDER BY DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) DESC, LIMIT 1', 'Integer'));
array_push($report_questions_data, array(268, 17, '05b', 'Audio Recordings: Downloadable Units Held at end of the fiscal year', 'Query', 'SELECT `Total` FROM `SRPhysicalCollection` WHERE (DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) < DATE(\'|endyear|-|startmonth|-01\')) AND (`Material` = \'Audio\') AND (`MaterialType` = \'Digital\') ORDER BY DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) DESC, LIMIT 1', 'Integer'));
array_push($report_questions_data, array(269, 17, '06a', 'DVDs/Videos: Physical Units Held at end of the fiscal year', 'Query', 'SELECT `Total` FROM `SRPhysicalCollection` WHERE (DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) < DATE(\'|endyear|-|startmonth|-01\')) AND (`Material` = \'Video\') ORDER BY DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) DESC, LIMIT 1', 'Integer'));
array_push($report_questions_data, array(270, 17, '06b', 'DVDs/Videos: Downloadable Units Held at the end of the fiscal yea', 'Query', 'SELECT `Total` FROM `SRPhysicalCollection` WHERE (DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) < DATE(\'|endyear|-|startmonth|-01\')) AND (`Material` = \'Video\') AND (`MaterialType` = \'Digital\') ORDER BY DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) DESC, LIMIT 1', 'Integer'));
array_push($report_questions_data, array(271, 17, '06c', 'Other Circulating Physical Items', 'Query', 'SELECT `Total` FROM `SRPhysicalCollection` WHERE (DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) < DATE(\'|endyear|-|startmonth|-01\')) AND (`Material` = \'Other\') ORDER BY DATE(CONCAT(`Year`, IF(`Month`+0 < 10, \'-0\', \'-\'), `Month`+0, \'-01\')) DESC, LIMIT 1', 'Integer'));
array_push($report_questions_data, array(272, 17, '06d', 'Total Physical Items', 'Calculation', '265,267,269,271', 'Integer'));
...
array_push($report_questions_data, array(275, 17, '09', 'Total Electronic Collections (17.7 + 17.8)', 'Calculation', '273,274', 'Integer'));
...
array_push($report_questions_data, array(279, 18, '04', 'Total number of materials loaned (18.1 + 18.2 + 18.3)', 'Calculation', '276,277,278', 'Integer'));
...
array_push($report_questions_data, array(285, 18, '10', 'Physical Item Circulation (18.5-18.9)', 'Calculation', '280,281,282,283,284', 'Integer'));
...
array_push($report_questions_data, array(287, 18, '12', 'Total Circulation of Materials (18.10 + 18.11)', 'Calculation', '285,286', 'Integer'));
...
array_push($report_questions_data, array(289, 18, '14', 'Electronic Content Use (18.11 + 18.13)', 'Calculation', '286,288', 'Integer'));
array_push($report_questions_data, array(290, 18, '15', 'Total Collection Use (18.10 + 18.11 + 18.13)', 'Calculation', '285,286,288', 'Integer'));
